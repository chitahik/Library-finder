# LIBRARY FINDER V4.6 DIAGNOSTIC
import os
import re
import time
import json
...
# -----------------------------
CHECKPOINT_VERSION = "v4.6-jongno-request-diagnostic-20260902"
...
def main():
    ...
    with st.expander("🧪 종로구 검색 진단 (V4.6)"):
        st.caption(
    ...
    st.caption(
        "※ V4.6 DIAGNOSTIC · 종로구 검색 form 선택값과 서버 응답의 검색결과 건수/큰글자책 문자열 수를 화면에서 직접 확인합니다. "
