...
# -----------------------------
CHECKPOINT_VERSION = "v4.5-nearest-result-card-20260902"
...
def main():
    ...
    st.caption(
        "※ V4.5 VERIFIED · 종로구는 제목 링크 주변의 가장 작은 실제 결과 카드를 찾아 일반판/큰글자책과 대출상태를 각각 판독합니다. "
