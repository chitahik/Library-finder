# LIBRARY FINDER V5.5 FINAL REGULAR-EDITION
import os
import re
import time
import json
...
# -----------------------------
CHECKPOINT_VERSION = "v5.5-ui-counts-20260903"
...
def main():
    ...
    st.caption(
        "※ V5.5 FINAL · 위쪽 숫자는 '오늘 바로 빌릴 수 있는 제목 수 / 내가 입력한 전체 제목 수'입니다. 실제 소장 복본 수는 아래 책별 상세 결과에서만 표시합니다. "
