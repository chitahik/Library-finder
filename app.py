...
# -----------------------------
CHECKPOINT_VERSION = "v4.1-consistent-summary-sen-strict-20260902"
...
def main():
    ...
    st.caption(
        "※ V4.1 VERIFIED · 요약/상세는 같은 숫자 데이터를 사용하며, 교육청 도서관은 실제 결과 카드의 제목·저자를 검증합니다. "
