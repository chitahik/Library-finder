# LIBRARY FINDER V5.4 FINAL REGULAR-EDITION
import os
import re
import time
import json
...
# -----------------------------
CHECKPOINT_VERSION = "v5.4-final-regular-edition-20260903"
...
def main():
    ...
    st.caption(
        "※ V5.4 FINAL · 종로구는 공식 통합검색 결과의 여러 페이지를 확인해 해당 도서관의 일반판만 판독합니다. "
